...
import com.darcye.sqlitelookup.adapter.SimpleListAdapter.SimpleItemViewHodler;

public abstract class SimpleListAdapter<T> extends RecyclerView.Adapter<SimpleItemViewHodler>{
